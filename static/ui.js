...
function _assistantRoleHtml(tsTitle=''){
  ...
  return `<div class="msg-role assistant" ${tsTitle?`title="${esc(tsTitle)}"`:''}><img class="role-icon assistant avatar-placeholder" src="static/fox_avatar_cropped.jpg" alt="${esc(_bn)}" width="20" height="20" decoding="async"><span style="font-size:12px">${esc(_bn)}</span></div>`;
}
