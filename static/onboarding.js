const ONBOARDING={status:null,step:0,steps:['system','setup','search','workspace','password','finish'],form:{provider:'openrouter',workspace:'',model:'',password:'',apiKey:'',baseUrl:'',braveApiKey:''},active:false,probe:{status:'idle',error:null,detail:'',models:null,probedKey:''}};
