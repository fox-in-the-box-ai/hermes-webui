...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    onboarding_lead: 'Hermes Agent is the brain — connected to models through OpenRouter, private on your box. Three quick steps and you are in.',
    onboarding_back: 'Back',
    onboarding_continue: 'Continue',
    onboarding_skip: 'Skip setup',
    onboarding_skipped: 'Setup skipped — using existing config.',
    onboarding_open: 'Get started',
    onboarding_step_system_title: 'The brain is here',
    onboarding_step_system_desc: 'We confirm Hermes Agent is reachable from this Web UI — fast, clean, under your control.',
    onboarding_step_setup_title: 'Connect the models',
    onboarding_step_setup_desc: 'Pick how you authenticate and save your key locally in Hermes. One page to configure; the Fox handles the rest.',
    onboarding_fixed_model_note: 'New chats use moonshotai/kimi-k2.6 by default. You can change the model anytime in Settings.',
    onboarding_step_workspace_title: 'Workspace + model',
    onboarding_step_workspace_desc: 'Pick defaults for new sessions and chat.',
    onboarding_step_password_title: 'Lock the box (optional)',
    onboarding_step_password_desc: 'Same security-by-design idea as the rest of the stack — add a password if this UI leaves localhost.',
    onboarding_step_finish_title: 'Finish',
    onboarding_step_finish_desc: 'Review and enter the app.',
    onboarding_notice_system_ready: "The Fox's brain looks reachable — Hermes Agent is talking to this interface.",
    onboarding_notice_system_unavailable: 'Hermes Agent is not fully awake yet. You can still continue; heavy setup may need a terminal.',
    ...
    onboarding_notice_password_recommended: 'Optional — recommended if you open the UI beyond your machine.',
  ...
  folder_add_as_space_title: 'スペースとして追加?',
    ...
    onboarding_lead: 'Hermes Agent が頭脳 — OpenRouter 経由でモデルにつながり、このボックスの中にとどまります。3 ステップで中へ。',
    onboarding_back: '戻る',
    onboarding_continue: '続ける',
    onboarding_skip: 'セットアップをスキップ',
    onboarding_skipped: 'セットアップをスキップ — 既存設定を使用します。',
    onboarding_open: 'はじめる',
    onboarding_step_system_title: '頭脳の確認',
    onboarding_step_system_desc: 'Hermes Agent がこの Web UI から届くか確認します。速く、すっきり、あなたの手の中で。',
    onboarding_step_setup_title: 'モデルにつなぐ',
    onboarding_step_setup_desc: '認証方法を選び、キーは Hermes にローカル保存。設定はこの一ページ — あとは Fox に任せて。',
    onboarding_fixed_model_note: '新規チャットの既定モデルは moonshotai/kimi-k2.6 です。設定からいつでも変更できます。',
    onboarding_step_workspace_title: 'ワークスペース + モデル',
    onboarding_step_workspace_desc: '新規セッションとチャットのデフォルトを選択します。',
    onboarding_step_password_title: '箱に鍵（任意）',
    onboarding_step_password_desc: '設計どおりのセキュリティ — この UI をローカル以外に出すならパスワードを。',
    onboarding_step_finish_title: '完了',
    onboarding_step_finish_desc: '確認してアプリに入ります。',
    onboarding_notice_system_ready: 'Fox の頭脳は届いています — Hermes Agent がこの画面と話せています。',
    onboarding_notice_system_unavailable: 'Hermes Agent はまだ十分に起きていません。続行はできますが、重い設定はターミナルが必要なことがあります。',
    onboarding_check_agent: 'Hermes Agent',
    ...
    onboarding_notice_password_recommended: '任意ですが、この UI をマシンの外に出すなら推奨します。',
