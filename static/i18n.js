...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    // onboarding
    onboarding_badge: 'SETUP',
    onboarding_title: 'Meet your Fox.',
    onboarding_lead: 'A private AI that lives on your machine. Let\u2019s get it running.',
    // 3-step wizard
    onboarding_step_provider_title: 'AI provider',
    onboarding_step_provider_desc: 'Connect an AI service.',
    onboarding_step_password_title: 'Password',
    onboarding_step_password_desc: 'Protect the web UI.',
    onboarding_step_done_title: 'Done',
    onboarding_step_done_desc: 'Your Fox is ready.',
    onboarding_done_headline: 'Your Fox is awake.',
    onboarding_done_body: 'Your box is sealed. Everything stays on your machine.',
    onboarding_guide_get_key: 'How to get your API key',
    onboarding_guide_setup: 'How to set up',
    onboarding_more_providers: 'More providers\u2026',
